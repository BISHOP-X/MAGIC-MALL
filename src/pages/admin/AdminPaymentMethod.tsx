  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 text-white">
        ...
        <p className="text-white/80 mt-1">Configure accepted payment methods</p>
      </div>
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-2">Payment method settings are being set up.</p>
      </div>
    </div>
  )
}
